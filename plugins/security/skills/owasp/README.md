...
- OWASP reference files in `references/top10-*/` (except Mobile, see below): [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/), sourced from [OWASP GitHub repositories](https://github.com/OWASP)
