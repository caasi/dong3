...
For leaf memoization to work, callbacks passed as props must have stable identity across renders — see `model-stable-derivation-identity` (Surface 2) for how curried event handlers in lists undermine this.
