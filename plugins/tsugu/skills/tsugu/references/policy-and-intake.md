...
The schema-version stamp (current: `7`). It is the first line of the file, and a
...
1→2→3→4→5→6→7 for a schema-1 repo) or is a plain idempotent repair (stamp already
current).
